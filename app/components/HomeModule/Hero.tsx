    ...
    <section id="about-me" className="grid grid-cols-12 gap-y-8 lg:gap-0 py-0 px-2 md:py-4 content-center">
      <div className="col-start-1 col-span-full order-2 text-center lg:text-left lg:col-span-5 lg:row-start-1 self-center">
        <div className="font-bold mb-3 dark:text-white">
          <div className="break-keep text-3xl md:text-4xl lg:text-4xl xl:text-6xl xl:mb-3 bg-gradient-to-r bg-clip-text text-transparent from-teal-600 via-blue-900 to-primary dark:from-teal-400 dark:to-blue-600">
            &#60;Developer&#47;&#62;
          </div>
        ...
        <div className="relative mb-6">
          <h1 className="font-medium text-lg md:text-2xl mr-2 inline dark:text-white">
            I&lsquo;m Huy (tuanhuydev), a software engineer from Viet Nam
            <Image
              width={28}
              height={20}
        ...
        <div className="dark:text-white text-xs md:text-base mb-10">
          <div className="mb-1 text-slate-700 dark:text-slate-400">
            ...
            <strong>quality</strong>, and <strong>efficiency</strong>.
          </div>
          <div className="text-slate-700 dark:text-slate-400">
            Driven by <strong>problem-solving</strong> and <strong>continuous improvement</strong>, I strive to build
            solutions that bring real value to people and businesses. 🚀
          </div>
        </div>
      ...
      <div className="col-start-1 col-span-full lg:col-start-7 relative overflow-x-hidden h-max sm:overflow-visible">
        <ul className="grid grid-cols-12 gap-1 md:gap-4 lg:gap-5 xl:gap-5 grid-rows-4 list-none m-0 p-0">
          <li className={`${graphicStyles} col-start-2 row-start-2`}>#NextJS</li>
          <li className={`${graphicStyles} col-start-1 opacity-80 row-start-4`}>#AWS</li>
          <li className={`${graphicStyles} col-start-6 row-start-1`}>#Javascript</li>
          <li className={`${graphicStyles} col-start-11 row-start-1`}>#VueJS</li>
          <li className={`${graphicStyles} col-start-10 row-start-3`}>#Angular</li>
          <li className={`${graphicStyles} col-start-10 row-start-2`}>#ReactJS</li>
          <li className={`${graphicStyles} col-start-1 opacity-80 row-start-1`}>#Typescript</li>
          <li className="col-start-5 col-span-4 row-start-2 row-span-2 m-2 p-2 relative flex justify-center items-center">
            <Image
          ...
          <li className={`${graphicStyles} col-start-5 col-span-5 row-start-4`}>#Web Development</li>
          <li className={`${graphicStyles} col-start-11 opacity-80 col-span-2 row-start-4`}>#CI/CD</li>
          <li className={`${graphicStyles} col-start-2 opacity-80 col-span-2 row-start-3`}>#English</li>
        </ul>
      </div>
    </section>
  );
