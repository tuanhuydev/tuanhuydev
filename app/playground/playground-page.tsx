...
This is a regular paragraph. By default, all text is treated as paragraphs unless you specifically format them as headings, lists, or other block elements.

Here&apos;s another paragraph to demonstrate the default paragraph behavior. You can toggle between **Rich Text** and **Markdown** modes using the toggle buttons in the toolbar.
...
- **Mode Toggle**: Switch between rich text and markdown editing
...
This is yet another paragraph showing how text naturally flows as paragraphs when you&apos;re just typing normally.
...
Use the toolbar above to format your text, or try these features:

- **Toggle Modes**: Use the Rich Text/Markdown toggle buttons in the toolbar
- **Keyboard Shortcuts**: 
...
Start editing this text or replace it with your own content! Text is automatically treated as paragraphs by default.`;
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr", md: "repeat(4, 1fr)" }, gap: 2 }}>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Switch between rich text and raw markdown editing modes seamlessly
              </Typography>
            </CardContent>
          </Card>
        </Box>
