...
export default function HighlightPost({ post, className }: HighlightPostProps) {
  ...
  return (
    <a
      ...
      <div className="z-0 h-full flex flex-col rounded-md relative bg-white dark:bg-slate-800 dark:border dark:border-slate-700 px-5 py-3">
        {thumbnail && (
          <div className="w-full h-72 lg:h-72 grow relative mb-2 overflow-hidden">
            <Image
              src={thumbnail}
              className="object-cover transition-all duration-500 rounded-md hover:scale-105"
              alt={title}
              fill
              sizes="50vw"
            />
