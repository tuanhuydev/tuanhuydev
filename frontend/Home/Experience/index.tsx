	...
	const Projects = useMemo(
		() =>
			MOCK_PROJECTS.map((project: ObjectType) => (
				<div
					className={`${styles.card} ${styles[theme]} shadow-200 items-center relative p-3 h-96 w-full md:w-80 max-w-full border-2 border-transparent dark:border-slate-700 dark:text-white rounded-md`}
					key={project.title}>
