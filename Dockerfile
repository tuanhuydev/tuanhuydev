...
FROM --platform=linux/amd64 node:25.2.1-alpine AS deps
...
FROM --platform=linux/amd64 node:25.2.1-alpine AS builder
...
FROM --platform=linux/amd64 node:25.2.1-alpine AS runner
WORKDIR /app
