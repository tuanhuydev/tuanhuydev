...
FROM --platform=linux/amd64 node:25.3.0-alpine AS deps
...
FROM --platform=linux/amd64 node:25.3.0-alpine AS builder
...
FROM --platform=linux/amd64 node:25.3.0-alpine AS runner
WORKDIR /app
